...
# AÑADIDO: Grabar voltajes en NEURON
...
axs[1, 0].plot(df_plot['Time'], df_plot['w1'], label=r'$w_1$', color='darkred')
axs[1, 0].plot(df_plot['Time'], df_plot['w2'], label=r'$w_2$', color='darkgreen')
...
axs[1, 1].plot(t_np, w1_np, label=r'$w_1$', color='darkred')
axs[1, 1].plot(t_np, w2_np, label=r'$w_2$', color='darkgreen')
...
# 1. Neun Arriba (Voltajes)
p_neun_v = figure(**kwargs_neun)
p_neun_v.line(df_plot['Time'], df_plot['V1pre'], legend_label="V_pre1", color="red", line_width=1.5)
p_neun_v.line(df_plot['Time'], df_plot['V2pre'], legend_label="V_pre2", color="green", line_width=1.5)
p_neun_v.line(df_plot['Time'], df_plot['Vpost'], legend_label="V_post", color="blue", line_width=1.5)
...
# 3. NEURON Arriba (Voltajes)
p_neuron_v = figure(**kwargs_neuron)
p_neuron_v.line(t_np, vpre1_np, legend_label="V_pre1", color="red", line_width=1.5)
p_neuron_v.line(t_np, vpre2_np, legend_label="V_pre2", color="green", line_width=1.5)
p_neuron_v.line(t_np, vpost_np, legend_label="V_post", color="blue", line_width=1.5)
...
for p in [p_neun_v, p_neun_w, p_neuron_v, p_neuron_w]: 
